...
class UpdatePillar(Task[UpdatePillarInput, APIResponse[None]]):
    def __init__(self, assessment_service: IAssessmentService) -> None:
        super().__init__()
        self.assessment_service = assessment_service

    @override
    def execute(self, event: UpdatePillarInput) -> APIResponse[None]:
        ...
        self.assessment_service.update_pillar(assessment, event.pillar_id, event.pillar_dto)
        return APIResponse(
            status_code=OK,
            body=None,
        )
