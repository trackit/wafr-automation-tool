...
PARAMS="Owner=\"$STAGE\" Debug=\"$DEBUG\" InitialUserEmail=\"$INITIAL_USER_EMAIL\" LogRetentionInDays=\"$LOG_RETENTION_IN_DAYS\" GenAIMaxRetries=\"$GEN_AI_MAX_RETRIES\" AIFindingsAssociationChunkSize=\"$AI_FINDINGS_ASSOCIATION_CHUNK_SIZE\""
